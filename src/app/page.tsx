...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      {/* Hero Section — pull up behind the transparent navbar */}
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden -mt-[70px]">
        {/* Background image */}
        <div
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-[fadeSlideUp_1s_ease-out]">
          ...
          <p className="text-gold-400 font-body text-sm tracking-[0.35em] uppercase mb-4">
            Premium Indian Fashion
          </p>

          <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-bold text-white mb-4 leading-[0.9]">
            RS <span className="text-gold-500">Boutique</span>
          </h1>

          <p className="font-display text-2xl md:text-3xl text-gold-400/90 italic mb-6">
          ...
          <div className="flex items-center justify-center gap-4 mt-12">
            <div className="w-24 h-[1px] bg-gradient-to-r from-transparent to-gold-500/40" />
            <div className="w-2 h-2 rotate-45 border border-gold-500/40" />
            <div className="w-24 h-[1px] bg-gradient-to-l from-transparent to-gold-500/40" />
          </div>
        </div>
      ...
      <section
        ref={features.ref}
        className={`bg-maroon-900 py-8 transition-all duration-700 ${features.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                <p className="font-body font-semibold text-white text-sm">Free Shipping</p>
                <p className="font-body text-ivory-200/60 text-xs mt-0.5">On orders over {formatPrice(2999)}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                <p className="font-body font-semibold text-white text-sm">Authentic Handcraft</p>
                <p className="font-body text-ivory-200/60 text-xs mt-0.5">Artisan-made pieces</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                <p className="font-body font-semibold text-white text-sm">Easy Returns</p>
                <p className="font-body text-ivory-200/60 text-xs mt-0.5">15-day return policy</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                <p className="font-body font-semibold text-white text-sm">Secure Payment</p>
                <p className="font-body text-ivory-200/60 text-xs mt-0.5">100% protected checkout</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        ref={categories.ref}
        className={`py-20 px-4 bg-ivory-100 transition-all duration-700 delay-100 ${categories.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      >
        <div className="max-w-7xl mx-auto">
          {/* Section Title */}
          <div className="text-center mb-14">
            <p className="text-gold-600 font-body text-sm tracking-[0.25em] uppercase mb-3">Explore</p>
            ...
            {FEATURED_CATEGORIES.map((cat, idx) => (
              ...
              >
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-center p-6">
                  ...
                  <span className="inline-flex items-center gap-2 text-gold-400 font-body text-sm tracking-wider uppercase group-hover:gap-3 transition-all duration-300">
                    Explore
      ...
      <section
        ref={products.ref}
        className={`py-20 px-4 bg-ivory-200 transition-all duration-700 delay-200 ${products.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      >
        <div className="max-w-7xl mx-auto">
          {/* Section Title */}
          <div className="text-center mb-14">
            <p className="text-gold-600 font-body text-sm tracking-[0.25em] uppercase mb-3">Handpicked For You</p>
            <h2 className="font-display text-4xl md:text-5xl font-bold text-maroon-900 mb-4">
              Curated Collection
            </h2>
            <div className="flex items-center justify-center gap-3">
      ...
      <section
        ...
        className={`py-20 px-4 bg-ivory-100 transition-all duration-700 delay-300 ${testimonials.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      >
        <div className="max-w-7xl mx-auto">
          {/* Section Title */}
          <div className="text-center mb-14">
            <p className="text-gold-600 font-body text-sm tracking-[0.25em] uppercase mb-3">Voices of Trust</p>
            <h2 className="font-display text-4xl md:text-5xl font-bold text-maroon-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, idx) => (
              ...
              >
                {/* Quote mark */}
                <svg className="absolute top-6 right-6 w-10 h-10 text-gold-500/15" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <p className="font-body text-ivory-200/70 mb-8">
          ...
          {subscribed ? (
            <div className="bg-gold-500/10 border border-gold-500/30 rounded-lg p-6">
              <svg className="w-12 h-12 text-gold-500 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <p className="font-display text-xl text-white">Thank you for subscribing!</p>
              <p className="font-body text-ivory-200/60 text-sm mt-1">Welcome to the RS Boutique family.</p>
            </div>
          ) : (
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              <input
                ...
                required
                className="flex-1 px-5 py-3.5 bg-white/10 border border-gold-500/30 rounded-sm text-white placeholder-ivory-200/40 font-body text-sm focus:outline-none focus:border-gold-500 transition-colors"
              />
              <button
                type="submit"
                className="px-8 py-3.5 bg-gold-500 text-maroon-900 font-body font-semibold text-sm tracking-wider uppercase rounded-sm hover:bg-gold-400 transition-colors duration-300"
              >
                Subscribe
              </button>
            </form>
