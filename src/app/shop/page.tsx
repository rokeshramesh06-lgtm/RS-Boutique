      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-4">
          ...
          <form onSubmit={handleSearch} className="flex-1 flex gap-2">
            ...
            <button
              ...
              className={`relative flex items-center gap-2 px-4 py-3 rounded-lg font-body text-sm transition-all ${
                filterOpen
        ...
        {(selectedCategory || search) && (
          <div className="flex flex-wrap items-center gap-2 mb-6">
            <span className="font-body text-sm text-gray-500">Active:</span>
            {selectedCategory && (
              <button
        ...
        {/* Products Grid — full width, larger images */}
        {loading ? (
